...
public class QParticipant extends EntityPathBase<Participant> {
    ...
    public final com.youngman.mop.domain.schedule.domain.QSchedule schedule;
    ...
    public QParticipant(Class<? extends Participant> type, PathMetadata metadata, PathInits inits) {
        ...
        this.schedule = inits.isInitialized("schedule") ? new com.youngman.mop.domain.schedule.domain.QSchedule(forProperty("schedule"), inits.get("schedule")) : null;
    }
